            ...
            <table className="w-full text-right">
              <thead className="bg-gray-100 border-b sticky top-0">
                <tr>
                  ...
                  <th className="p-4 border-l font-bold text-gray-700 text-center">فی اکائی قیمت</th>
                ...
                {loading ? (
                  ...
                  currentItems.map((item) => (
                    <tr key={item.udharitem_id} className="border-b hover:bg-amber-50/50">
                      ...
                      <td className="p-4 border-l text-center text-gray-700">{item.requested_unit}</td>
                      <td className="p-4 border-l text-center font-mono text-blue-700">Rs. {item.unit_price?.toLocaleString() || 0}</td>
                  ...
                  <tr>
                    <td colSpan="8" className="p-16 text-center text-gray-500">
                      کوئی اُدھار آئٹم موجود نہیں ہے۔
                    </td>
                  </tr>
                )}
              </tbody>
